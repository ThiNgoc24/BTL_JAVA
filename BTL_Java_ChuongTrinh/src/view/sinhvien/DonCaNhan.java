...
public class DonCaNhan extends javax.swing.JDialog {
    ...
    //mã sinh viên là mã tài khoản sinh viên đang đăng nhập
    ...
    TTDonCaNhan dcn = new TTDonCaNhan();
    ...
    public boolean checkDonHopLe() {
        List<TTDonCaNhan> ds = DonCaNhanController.readDonFromFile("src/Data/DSDonCaNhan.txt");
        ...
        if (!this.setResults()) {
            ...
            try {
                if (checkDonHopLe() && checkDonHopLe_FileDSDonTapThe()) {
                    ...
                    // Gọi phương thức lưu trữ trong controller
                    DonCaNhanController.saveDonCaNhanInfo(donCaNhan);
