 ...
 */
public class ChiTietDonTapThe extends JDialog  {

    /**
     * Creates new form ChiTietDonTapThe
     */
    private SinhVienTapThe sinhVienTapThe;
     private boolean isModeAdd;  // Biến để xác định chế độ là thêm mới hay sửa
    public ChiTietDonTapThe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChiTietDonTapThe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
