...
public class QuanLyNganhTheoKhoa extends javax.swing.JDialog {
    ...
    public void saveFileNganh() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(pathNganh))) {
            ...
            for (Nganh nganh : listNganh) {
                System.out.println(nganh.toString());
    ...
    private void btnXemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemActionPerformed
        ...
        try {
            if (selectedRow == -1) {
                ...
                String maNganh = (String) tbl_Nganh.getValueAt(selectedRow, 0);
...
//                }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (selectedRow == -1) { // Kiểm tra xem có dòng nào được chọn không
            ...
            String maNganh = tableModel.getValueAt(selectedRow, 0).toString();
            String tenNganh = tableModel.getValueAt(selectedRow, 1).toString();
