 ...
 * @author Le Thi Ngoc
 */
public class ĐonCaNhan extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ĐonCaNhan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
